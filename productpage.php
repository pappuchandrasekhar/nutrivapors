...
if($height>161){
  ...
  /*  <img src="uploads/baner_gallery/<?php echo $all_banners->image; ?>" width="<?=$setwidth;?>" />*/
	...
	?>
             ...
             <li> 
            <!--  <a href="product_discription.php?spid=">-->
    ...
    <div class="pic">           
               ...
               <?php /*?><a href="<?=SITEURL?>/<?=seoClass::fURL('product_discription.php?spid='.$prolist->spid)?>"> <?php */?>
                
                <img  src="<?=SITEURL?>/images/cartround_55.png"><?php /*?></a><?php */?>
               </span>
