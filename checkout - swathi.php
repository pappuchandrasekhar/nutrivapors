...
/* function validateAge ()($then, $min){$then = strtotime($then);$min = strtotime('+18 years', $then);echo $min; if(time() < $min)  { die('Not 18'); 
		...
		//alert(hi);
		$.ajax({url:"updateaddress.php?first_name="+$("#fname").val()+"&&last_name="+$("#lname").val()+"&&email="+$("#bemail").val()+"&&address="+$("#addr1").val()+"&&city="+$("#city").val()+"&&state="+$("#state").val()+"&&zip_code="+$("#zip").val()+"&&fax="+$("#fax").val()+"&&companyname="+$("#cmpny").val()+"&&telephone="+$("#telephone").val()+"&&country="+$("#country").val()+"&&date="+$("#date").val(),success:function(result){ //alert(result); 
		}});
	}
	...
	{	
		...
		if($("#billaddress").val()=="new" || $('#checktype1').is(':checked'))
		{
			...
			//alert(elmt);
			$("#sdiv2").html(elmt);	
			$.ajax({url:"updatesaddress.php?first_name="+$("#fname").val()+"&&last_name="+$("#lname").val()+"&&email="+$("#bemail").val()+"&&telephone="+$("#telephone").val()+"&&fax="+$("#fax").val()+"&&companyname="+$("#cmpny").val()+"&&address="+$("#addr1").val()+"&&city="+$("#city").val()+"&&state="+$("#state").val()+"&&zip_code="+$("#zip").val()+"&&country="+$("#country").val()+"&&date="+$("#date").val(),success:function(result){ //alert(result);
			 }});
...
$("#but2").click(function(){	
	...
	else
	{
		...
		$("#sdiv2").html(elmt);	
		//alert(hai); 
		$.ajax({url:"updatesaddress.php?first_name="+$("#sfname").val()+"&&last_name="+$("#slname").val()+"&&email="+$("#semail").val()+"&&address="+$("#saddr1").val()+"&&city="+$("#scity").val()+"&&telephone="+$("#stelephone").val()+"&&city="+$("#scity").val()+"&&fax="+$("#sfax").val()+"&&state="+$("#sstate").val()+"&&zip_code="+$("#szip").val()+"&&companyname="+$("#scmpny").val()+"&&country="+$("#scountry").val(),success:function(result){ //alert(result); 
		}});
...
$("#but3").click(function(){	
	if(!$("input[name='shipmethod']:checked").val()){
		...
		if(!$.isNumeric(m))
		{
			...
			/*comments*/
			if($("#sstate").val()=="California" || $("#sstate").val()=="CA" ){
...
<!--End clearfix-->
                ...
                <div class="checkout_left">
                    ...
                    <div class="checkout_method" id="div0">
                       ...
                       <div class="check_left">
                         ...
                         <div class="radio_btn"><input type="radio" name="checktype" id="checktype1" class="chktype" value="guest"> Checkout as Guest</div><!--radio_btn-->
  ...
  <input type="hidden" id="user_email" name="user_email" value="<?php echo $ugetdat->email; ?>" />
                    ...
                    <div class="checkout_method"  id="div1"  style="display:none;">
                       ...
                       <div class="checkleft_btn"><input type="text" name="fname" id="fname" style='display:block;'/> </div><!--checkleft_btn-->
                       </div><!--check_left-->
                       ...
                       <div class="checkleft_btn">    <input type="text" name="email" id="bemail" style='display:block;'/> </div><!--checkleft_btn-->
                       </div><!--check_right-->
                       <div class="clear_fix"></div>
                      ...
                      <!-- <div class="checkleft_btn1">
                       ...
                       <div class="checkleft_btn">   <input type="text" name="city" id="city" style='display:block;'/>
    ...
    width: 95%; display:block;" >     
             ...
             <option value="">Select Country</option>
				   <?php while($row=mysql_fetch_array($conres)){ ?>
                  ...
                  <?php } ?>
                       ...
                       <div class="checkleft_btn"> <input type="date" name="date" id="date" style='display:block;'/> </div><!--checkleft_btn-->
                       </div>
                       ...
                       <div class="checkleft_btn"> <input type="text" name="zip" id="zip" style='display:block;'/> </div><!--checkleft_btn-->
                       </div><!--check_left-->
                       
                       <div class="check_right">
                       <div class="checkleft_text">State/Province <span>*</span> </div><!--checkleft_text-->
                       <div class="checkleft_btn"><input type="text" name="state" id="state" style='display:block;' /> </div><!--checkleft_btn-->
                       </div><!--check_right-->
                      
                       <div class="check_left">
                       <div class="checkleft_text">Telephone <span>*</span> </div><!--checkleft_text-->
                       <div class="checkleft_btn"> <input type="text" name="telephone" id="telephone" style='display:block;'/> </div><!--checkleft_btn-->
                       </div><!--check_left-->
 ...
 <div class="clear_fix"></div>
                   ...
                   <div class="shipping_btn"><input type="text" name="fname" id="sfname" style='display:block;'/>
                   ...
                   <div class="shipping_btn"><input type="text" name="email" id="semail" style='display:block;'/>
                   ...
                   <div class="shipping_btn"><textarea name="addr1" id="saddr1" style="width:473px; height:60px; padding:0px; display:block;"></textarea>  <b id="svaladdr1" class="valchk"></b></div><!--shipping_btn-->
                   <div class="clear_fix"></div>
                   
                    <div class="shipping_text">City: <span>*</span></div><!--shipping_text-->
                   <div class="shipping_btn"><input type="text" name="city" id="scity" style='display:block;'/>
             ...
             <option value="">Select Country</option>
              ...
              <b id="svalcountry" class="valchk"></b>
                  ...
                  <input type="text" name="state" id="sstate"  style='display:block;'/>
                   ...
                   <div class="shipping_btn"> <input type="text" name="telephone" id="stelephone" style='display:block;'/>
                   ...
                   <div class="clear_fix"></div>
					...
					<div class="clekedform" id="div3" style="display:none; min-height:50px; padding-top:10px; ">
                        ...
                        <!--  <input type="radio" name="shipmethod" class="shipmethcal" onClick="getrates(this.value);" value="<?php echo $sitesettings->shipping_method; echo "$".$rate; ?>"> <?php echo $sitesettings->shipping_method;?> <span style="float:right; margin-right:150px;"><?php echo "$".$rate; ?> </span>-->
						  ...
						  <input type="radio" name="shipmethod" class="shipmethcal" onClick="getrates(this.value);" value="<?php echo $_SESSION['shippingamount'] ; echo "$".$_SESSION['shippingamount']; ?>"> <?php echo $sitesettings->shipping_method;?> <span style="float:right; margin-right:150px;"><?php echo "$".$_SESSION['shippingamount']; ?> </span>
                    ...
                    <?php if($prd->discount=='no'){?>
                      ...
                      <!-- <p style="font-size:15px;"> Promo Code</p>-->
                        ...
                        <input type="hidden" value="Apply"  onclick="javascript:return validateCouponcode()" style="padding:6px 10px; background-color:#8ebe29; border:none; font-family: 'Roboto', sans-serif; font-size:14px; margin-top:10px; -webkit-border-radius: 3px;	-moz-border-radius: 3px; border-radius: 3px; color:#FFF; cursor:pointer;"/>
                    ...
                    <div class="formtextsub" id="discount_coupon_di">
                        <!--Promo Code-->
                       <input type="hidden" name="couponcode" id="couponcode"   class="textcoupon">
                        <input type="hidden" name="cartrandomid" id="cartrandomid" value="<?php echo $_SESSION['CART_TEMP_RANDOM']?>">
                       
                      <!--  <input type="button" value="Apply"   onclick="javascript:return validateCouponcode()" style="padding:6px 10px; background-color:#8ebe29; border:none; font-family: 'Roboto', sans-serif; font-size:14px; margin-top:10px; -webkit-border-radius: 3px;	-moz-border-radius: 3px;  border-radius: 3px; color:#FFF; cursor:pointer;" />-->
                        <?php
						$coupondiscountamount = $cartobj->discountCaliculation($prd->discountamount,$prd->distype,$totprc);
						?>
