              ...
              //$productslist= $callConfig->getAllRows($products);
			   ...
			   if(count($productslistnew)>0){
				  foreach($productslist as $prolist){
					   ...
					   $queryvalue="select MIN(real_price) as real_price,id,bulk_price,size from tb_store_value where bulk_price!='' and spid=".$prolist->spid;
            ...
            <!--  <a href="product_discription.php?spid=<?php echo $prolist->spid?>">-->
               ...
               <form method="post">
                ...
                <!--<a href="#"><img src="<?=SITEURL?>/images/cartround_55.png" alt=""></a>--></span>
                 ...
                 <span style="float:left; padding-left:15px; margin-top:5px;"><h3>$<?php echo $minimumvalues->bulk_price;?></h3></span>
                  <input type="hidden" name="spd" id="spd" value="<?php echo $prolist->spid;?>"/>
                        ...
                        <input type="hidden" name="price2" value="<?php echo $minimumvalues->bulk_price; ?>"/>  
                        <input type="hidden" name="price" value="<?php echo $minimumvalues->bulk_price*1; ?>"/>  
