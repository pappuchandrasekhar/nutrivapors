...
$("#but1").click(function(){
	...
	{	
		...
		//alert(hi);
		$.ajax({url:"updateaddress.php?first_name="+$("#fname").val()+"&&last_name="+$("#lname").val()+"&&email="+$("#bemail").val()+"&&address="+$("#addr1").val()+"&&city="+$("#city").val()+"&&state="+$("#state").val()+"&&zip_code="+$("#zip").val()+"&&country="+$("#country").val(),success:function(result){ //alert(result); 
		}});
	}
	if($("#shipto").prop('checked'))
	{	
		$.ajax({url:"test.php",success:function(result){ /* Retrieve data from biiling table */ }});
		window.setTimeout(function(){$("#shipinfo").css({background:bck,color:text});$("#shipmeth").css({background:bck,color:text});$("#div3").slideDown();$("#sdiv1").slideDown();$("#sdiv2").slideDown();$("#div1").slideUp(); b=true;c=true; },stime);
		if($("#billaddress").val()=="new")
		{
			var elmt = '<ul class="billlis"><li>'+$("#fname").val()+'&emsp;'+$("#lname").val()+'</li><li>'+$("#bemail").val()+'</li><li>'+$("#addr1").val()+'</li><li>'+$("#city").val()+'</li><li>'+$("#state").val()+','+$("#zip").val()+'</li><li>'+$("#country").val()+'</li></ul>';
			//alert(elmt);
			$("#sdiv2").html(elmt);	
			$.ajax({url:"updatesaddress.php?first_name="+$("#fname").val()+"&&last_name="+$("#lname").val()+"&&email="+$("#bemail").val()+"&&address="+$("#addr1").val()+"&&city="+$("#city").val()+"&&state="+$("#state").val()+"&&zip_code="+$("#zip").val()+"&&country="+$("#country").val(),success:function(result){ //alert(result);
			 }});
...
$("#but2").click(function(){	
	...
	else
	{
		...
		$("#sdiv2").html(elmt);	
		//alert(hai); 
		$.ajax({url:"updatesaddress.php?first_name="+$("#sfname").val()+"&&last_name="+$("#slname").val()+"&&email="+$("#semail").val()+"&&address="+$("#saddr1").val()+"&&city="+$("#scity").val()+"&&state="+$("#sstate").val()+"&&zip_code="+$("#szip").val()+"&&country="+$("#scountry").val(),success:function(result){ //alert(result); 
		}});
...
function payments(pays){if(pays=='creditcard'){$("#paydetails").slideDown();}else{$("#paydetails").slideUp();}}
  ...
  <input type="hidden" id="user_email" name="user_email" value="<?php echo $ugetdat->email; ?>" />
                    ...
                    $conres=mysql_query($con);?>
                            <select name="country" id="country" style="padding:3px; display:block;" >     
             ...
             <option value="">Select Country</option>
                  ...
                  <?php } ?>
                   ...
                   <div class="shipping_btn">   <?php $con="select * from tb_countries"; 
                    $conres=mysql_query($con);?>
                            <select name="country" id="scountry" style="padding:3px; display:block;" >     
              ...
              <b id="svalcountry" class="valchk"></b>
                  ...
                  <input type="text" name="state" id="sstate"  style='display:block;'/>
                   ...
                   <div class="clear_fix"></div>
					...
					<div class="clekedform" id="div3" style="display:none; min-height:50px; ">
                     	<div>
                    ...
                    <table width="100%" style="border:1px solid #4e4e4e !important" class="exampleone">
                        ...
                        <?php /*?><tr height="25">
                        <?php if($prd->distype!=''){?>
                        	<td colspan="3" align="right">Coupon:</td>
                        	<td align="right"> <?php
							$coupondiscountamount=$cart_obj->discountCaliculation($prd->discountamount,$prd->distype,$totprc);							
							?>
                        ...
                        {
                        ?>
                        	<td colspan="3" align="right" id="dispdisc1">Coupon:</td>
                    ...
                    <?php if($prd->discount=='no'){?>
                        ...
                        <input type="button" value="Apply"  onclick="javascript:return validateCouponcode()" style="position:relative; top:17px; margin-left:12px; alignment-adjust:central;" class="baccc"/>
                        </div>
                    <?php 
                ...
                <h5>   Your Checkout Progress</h5>
                   ...
                   <div class="billlisblog" id="sdiv1" style="display:none;">
                         <ul class="billlis">
                           <li>Sairam y</li>
                           <li>Vizag</li>
                   ...
                   <div class="billlisblog" id="sdiv2" style="display:none;">
                         <ul class="billlis">
                           <li>Sairam y</li>
                           <li>Vizag</li>
                           <li>Vizaag, Kenutiki, 55555</li>
                   ...
                   <div class="billlisblog" id="sdiv3" style="display:none;">
                         <ul class="billlis">
                           <li>Sairam y</li>
                           <li>Vizag</li>
                           <li>Vizaag, Kenutiki, 55555</li>
                   ...
                   <div class="billlisblog" id="sdiv4" style="display:none; float: right; margin-right: 95px;">
                         <ul class="billlis">
                           <li>Sairam y</li>
                           <li>Vizag</li>
                           <li>Vizaag, Kenutiki, 55555</li>
