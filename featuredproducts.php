...
$query="select * from tb_store_products where scid=".$_GET['id'];
...
<li><a href="<?=SITEURL?>/featuredproducts.php">Featured Products</a></li>
              </ul>
 ...
 <?php if(count($Allfeaturedlist)>0){
				  foreach($Allfeaturedlist as $prolist){
