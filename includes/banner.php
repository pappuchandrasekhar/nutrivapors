...
<?php /*?><!--<script src="jquery-1.8.2.min.js" type="text/javascript"></script>-->
...
$(document).ready(function() {
	$('#slideshow').nivoSlider({beforeChange: function(){
		$("#slideshow").find("a").each(function(){
		if(this.style.display == "block"){ $(this).addClass("hideme");};
     	});
	},afterChange: function(){
		$("#slideshow").find("a").each(function(){
		if(this.style.display == "block"){$(this).removeClass("hideme");}
		})
	}});
