...
<div id="header">
  <div class="div1">
    <div class="div2"><a href="index.php" ><img src="../uploads/site/<?php echo $site_settings_disp->site_image; ?>" style="width:185px; height:51px;" alt="Site Logo" /></a></div>
		...
		<a class="top" href="http://strongerrx.eu/administrator" target="_blank"  style="color:#FFFFFF; text-decoration:none;">SRX Europe Admin </a>
		</div>
    </div>
	<?php
	if($option!="com_login"){
    ...
    <ul class="left sf-js-enabled" style="display: block; ">
	 ...
	 <li id="catalog" <?php echo $left_adminlist_focus;?>><a class="top"  href="#">Users</a>
	  ...
	  <li id="catalog" <?php echo $left_store_focus;?>><a class="top"  href="#">Store</a>
        <ul style="display: none; visibility: hidden; ">
		 <li><a href="index.php?option=com_storecat">Category</a></li>
          ...
          <li><a href="index.php?option=com_storecoupons">Coupons</a></li>
		  <li><a href="index.php?option=com_storecoupons_insert">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;&raquo;&nbsp;&nbsp;Add Coupon</a></li>
	  ...
	  <li id="catalog" <?php echo $left_subscribers_focus;?>><a class="top"  href="#">Newsletter</a>
        ...
        <li><a href="index.php?option=com_newseventstemplateslist">Newsletter Templates</a></li>
      ...
      <?php */?>
        <li id="catalog" <?php echo $left_smallimages_focus;?>><a class="top"  href="index.php?option=com_smallimageslist">Official Partners</a>
        <ul style="display: none; visibility: hidden; ">
      ...
      <li id="catalog" <?php echo $left_affiliatebanners_focus;?>><a class="top"  href="index.php?option=com_affiliatebannerslist">Affiliate Banners</a>
        <ul style="display: none; visibility: hidden; ">
      ...
      <li id="catalog"><a class="top"  href="http://www.google.com/analytics" target="_blank">Analytics</a></li>
       ...
       <li id="catalog"><a class="top"  href="http://app.invoice2go.com/index.html" target="_blank">Invoice</a></li>
