...
&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>&nbsp;( If you want to add more sizes click below Plus button to Add ) </span></td>
     ...
     <div id='row<?=$i?>'><div style='border:1px solid #6DB5FF;width:615px; height:45px;padding:2px 2px 2px 2px;'><p>
     ...
     price:<input type='text' value="<?=$s_price->real_price?>" name='rs[]' id='rs<?=$i?>' class='inputtype_field_input' />&nbsp;&nbsp;Bulk price:<input type='text' value="<?=$s_price->bulk_price?>" name='brs[]' id='brs<?=$i?>' class='inputtype_field_input' /></p>
     <div class='clearfix'></div><a href='#' onClick='removeFormField("#row<?=$i?>"); return false;'>
     <img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;right:-618px' /></a></div><br></div>
...
$("#divTxt").append("<div id='row" + id + "'><div style='border:1px solid #6DB5FF;width:620px; height:45px;padding:2px 2px 2px 2px;'><p><select name='sid[]' id='sid"+id+"' class='select_medium'><option value=''>Select</option><?php print $optino; ?></select>price:<input type='text' name='rs[]' id='rs"+id+"' class='inputtype_field_input' /> Bulk Price:<input type='text' name='brs[]' id='brs"+id+"' class='inputtype_field_input' /> </p><div class='clearfix'></div><a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;'><img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;right:-623px' /></a></div><br></div>");
$("label").inFieldLabels(); 
	id = (id - 1) + 2;
