...
if($_GET['action']=="delete"){
  $brandObj->BrandsDelete($_GET['id']);
}
if($_POST['admininsert']=="Submit"){
   $brandObj->insertBrands($_POST);
}
if($_POST['admininsert']=="Update"){
   $brandObj->updateBrand($_POST);
}
if(isset($_GET['id']) && $_GET['id']!=""){
   $hdn_value="Update";
   $indivdata=$brandObj->getBrandData($_GET['id']); 
...
$orderby="DESC";
$allnewevnets=$brandObj->getAllBrandList('','','','','');
$total=$brandObj->getAllBrandsListCount('');

if($option!="com_brands_insert"){
?>
...
<tr>
<td align="left" valign="middle"><h1><img src="allfiles/map.jpeg" alt=""> Brands</h1></td>
<td align="right" valign="bottom"><input class="button button_add" value="" type="button" onclick="window.location.href='index.php?option=com_brands_insert';"></td>
</tr>
</table>
</div>
...
$(document).ready(function(){ 
	$(function() {
		...
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			var order = $(this).sortable("serialize") + '&action=updateBrands'; 
...
<div id="contentLeft" style="border:0px solid red;">
      <ul style="margin:0px;margin-left:-40px;margin-top:6px;">
        <li style="list-style:none;border:1px solid #CCCCCC;background-color:#F2F2F2;">
          <table width="100%">
            <thead>
              <tr height="25">
                <td width="216" align="left" valign="middle"><strong>SNo</strong></td>
                <td width="216" align="left" valign="middle"><strong>Brand Name</strong></td>
    ...
    <ul style="margin:0px;margin-left:-40px;">
                <?php
				$query  = "SELECT * FROM tb_brands ORDER BY display_order ASC";
        ...
        <li id="recordsArray_<?php echo $row['id']; ?>"  style="list-style:none" >
          <table width="100%" border="0" style="border:1px solid #EDE8E8;">
            <tr height="25">
              <td width="203" align="left" valign="middle"><?=($ii+1);?></td>
              <td width="203" align="left" valign="middle"><?php echo  stripslashes($row['title']); ?></td>
              
              <td width="751" align="left" valign="middle" >
              <?php if($row['image']!=''){?>
              <img src="../uploads/brands/<?php echo $row['image'];?>" height="50" width="100">
              <?php }else{?>
              <img src="../uploads/brands/no_preview.gif" height="75" width="220">
              <?php }?>
              </td>
              <td width="88" align="left" valign="middle" ><?php echo  $row['status']; ?></td>
              <td width="69" align="center" valign="middle" ><a title="edit" href="index.php?option=com_brands_insert&id=<?php echo $row['bid']?>"><img src="allfiles/icon_edit.png" alt="Edit" border="0"></a></td>
              <td width="88" align="center" valign="middle" ><a title="delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_brands&action=delete&id=<?php echo $row['bid'];?>'; return false;}"><img src="allfiles/icon_delete.png"  alt="Delete" border="0"/></a> </td>
            </tr>
          <?php
				$ii++; } } else{
			?>
			...
			if($_GET['ord']!="")
			$param.="&fld=".$_GET['fld'];
			$callConfig->paginavigation($start, $limit, $total, 'index.php?option=com_brands', $param);
			//print_r($_GET); exit;
			?>
			</ul>
			<?php 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="left" valign="middle"> <h1><img src="allfiles/map.jpeg" alt=""> Add Brands &nbsp;&nbsp;/&nbsp;&nbsp; Edit Brands</h1></td>
<td align="right" valign="bottom">&nbsp;</td>
</tr>
</table>
</div>
<div class="content">
<form action="index.php?option=com_brands_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
                <td width="6%" align="left" class="caption-field"><label class="title">BrandName:<span style=" color:#FF0000; font-size:14px">*</span></label></td>
          ...
          <td align="left" valign="middle"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
				...
				?>
                  <img src="../uploads/brands/<?php echo $indivdata->image; ?>" width="150" height="150" />
       ...
       <tr><td colspan="2" height="7"></td></tr>
         ...
         <tr>
				...
				<textarea name="bigtext" id="content_matter" cols="157" rows="20"><?php echo  stripslashes($indivdata->description);?></textarea>
	...
	<tr>
	<td align="left" valign="middle" colspan="2"><input name="hdn_id" type="hidden" value="<?php echo $indivdata->bid?>"><input value="<?php echo $hdn_value;?>" class="button button_add" type="hidden" name="admininsert"><?php /*?><input <?php echo $hdn_in_up;?> type="submit" value=""><?php */?><input <?php echo $hdn_in_up;?> type="submit" value="" >	</td>
	</tr>
        </table>
	</form>	
	</div>
