	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
			  ...
			  if(category=='1')
			  {
				 var ss=document.getElementById('sarat').style.display="block";  
				  var ss1=document.getElementById('sarat1').style.display="block";  
					 ...
					 var ss=document.getElementById('sarat').style.display="none";  
				var ss1=document.getElementById('sarat1').style.display="none";  
     ...
     <?php /*?>    <option value="<?php echo  stripslashes($indivdata->nicotinecontent);?>"><?php echo  stripslashes($indivdata->nicotinecontent);?></option>
          <option value="select">Select Nicotine Content</option>
                ...
                <option value="24mg">24 Mg</option><?php */?>
                <option value="select">Select Nicotine Content</option>
                <?php for($i=0;$i<21;$i++){?>
...
<?php
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>(If you want to add more sizes click below Plus button to Add ) </span></td>
     ...
     <div class='clearfix'></div><a href='javascript:void(0);' onClick='removeFormField("#row<?=$i?>");return false;'>
...
$("#divTxt").append("<div id='row" + id + "'><div style='border:1px solid #6DB5FF;width:880px; height:45px;padding:2px 2px 2px 2px;'><p><select name='sid[]' id='sid"+id+"' class='select_medium'><option value=''>Select</option><?php print $optino; ?></select> price:<input type='text' name='rs[]' id='rs"+id+"' class='inputtype_field_input' /> Bulk Price:<input type='text' name='brs[]' id='brs"+id+"' class='inputtype_field_input' />  Weight(oz):<input type='text' name='wrs[]' id='wrs"+id+"' class='inputtype_field_input' />Quantity:<input type='text' name='qns[]' id='qns"+id+"' class='inputtype_field_input' /> </p><div class='clearfix'></div><a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;'><img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;float:right;right:-35px' /></a></div><br></div>");
$("label").inFieldLabels(); 
	id = (id - 1) + 2;
