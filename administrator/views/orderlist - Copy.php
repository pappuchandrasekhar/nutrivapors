              ...
              <table width="90%" border="0" cellspacing="0" cellpadding="1">
                <tr>
                  <td width="46%">Filter By :
                    <select name="serchkeyword" id="serchkeyword" onchange="display(this,'coupcode');">
                      <option value="">-Choose-</option>
                      <option value="view">View Comments</option>
                      <option value="post">Post Comment</option>
                      <option value="del">Delivery Status</option>
                      <option value="inpro">In Process</option>
                      <option value="notdel">Not Delivered</option>
                      <option value="fol">Follow Up</option>
                      <option value="unfol">Un Follow</option>
                      <option value="coupcode">Coupon Code</option>
                    </select>
				<script type="text/javascript">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list">
      <thead>
        <tr height="25">
		  ...
		  <td width="79" align="center" valign="middle" >View Status</td>
      ...
      <tbody>
        <script type="">
					...
					function statusUpdate(st,id,index,userid)

					{
...

						{
							...
							jQuery.ajax({
								...
								data: "&status="+st+"&id="+id+"&userid="+userid,
...
$rs_customer=$callConfig->getRow($sel);
        ...
        <tr height="22">
          ...
          <td  align="left" valign="middle"><?php echo $rs_customer->first_name;?></td>
          <td  align="left" valign="middle"><?php echo $rs_customer->s_name;?></td>
          <td colspan="2" align="left" valign="middle"><a href="mailto:<?php echo $rs_customer->email_address;?>"><?php echo $rs_customer->email_address;?></a></td>
		...
		$(document).ready(function() {
          ...
          <td align="center" valign="bottom"><a href="javascript:void(0);"  id="resultdisp<?=$ii;?>" onclick="getdrop('<?=$ii;?>');"><?php echo ucfirst($all_orderlists->ord_status);?></a>
            <select name="statusdisp" id="statusdisp<?=$ii;?>" style="display:none;" onchange="statusUpdate(this.value,'<?php echo $all_orderlists->tx_id;?>','<?=$ii;?>','<?php echo $all_orderlists->reg_id;?>');">
              <option value="">-- Choose --</option>
            ...
            &nbsp; <a href="index.php?option=com_orderlist&smuid=<?php echo $all_orderlists->reg_id; ?>&smtid=<?php echo $all_orderlists->tx_id; ?>" title="Send Email"><img src="allfiles/mail.jpg" width="18" height="19" border="0" /></a></td>
			...
			<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Tracking @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
			 ...
			 <a href="javascript:void(0);" class="update_fancy" id="update_transaction<?php echo $all_orderlists->tx_id."-". $all_orderlists->reg_id;?>">Update</a>			 </td>
			 
			 <td width="79" align="center" valign="middle" >
			 <a href="javascript:void(0);" class="view_status" id="view_transaction<?php echo $all_orderlists->tx_id;?>">View</a>			 </td>
          
		  <!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Tracking Ends @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
		  
		  
		  <td align="center" valign="middle"><a title="delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_orderlist&action=delete&id=<?php echo $all_orderlists->tx_no;?>'; return false;}"><img src="allfiles/icon_delete.png"  alt="Delete" border="0"/></a> </td>
        </tr>
        <?php
