...
<div class="content">
	 <table width="100%" border="0" cellpadding="0" cellspacing="0"  id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
          <thead>
            <tr height="40">
              <th width="21" align="center" valign="middle">sno</th>
			  <th width="68" align="left" valign="middle" >Category</th>
             

		      <th width="122" align="left" valign="middle" >Product Name</th>
            
			   <th width="431" align="left" valign="middle" >Image</th>
              



              <th width="50" align="center" valign="middle" >Edit</th>
			  <th width="50" align="center" valign="middle" >Delete</th>
            </tr>
          </thead>
			<tbody>
			<?php
			...
			<td align="middle" valign="middle"x><a title="edit" href="index.php?option=com_storeproducts_insert&id=<?php echo $all_products->spid;?>"><img src="allfiles/icon_edit.png" alt="Edit" border="0"></a></td>
...
<div class="content">
<form action="index.php?option=com_storeproducts_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             ...
             <?php if($indivdata->nicotinecontent=='') {?>
             
             
               <tr>
               
             
         <td width="6%" align="left" class="caption-field"><label class="title">Nicotine Content :</label></td>
                <td width="94%" align="left" valign="middle">
                
                <select name="nicotinecontent" id="nicotinecontent" class="select_medium">
                <option value="">Select</option>
                <option value="0mg">0 Mg</option>
                <option value="2mg">2 Mg</option>
                <option value="4mg">4 Mg</option>
                <option value="6mg">6 Mg</option>
                <option value="8mg">8 Mg</option>
                <option value="10mg">10 Mg</option>
                <option value="12mg">12 Mg</option>
                <option value="14mg">14 Mg</option>
                <option value="18mg">18 Mg</option>
                <option value="20mg">20 Mg</option>
                <option value="24mg">24 Mg</option>
                                </select>              
 ...
 <?php } else {?>
        ...
        <td width="7%" align="left" class="caption-field"><label class="title">Nicotine Content:<span style=" color:#FF0000; font-size:14px">*</span></label></td>
        
        <td>
		
		
		<select name="nicotinecontent" id="nicotinecontent" class="select_medium">
         <option value="<?php echo  stripslashes($indivdata->nicotinecontent);?>"><?php echo  stripslashes($indivdata->nicotinecontent);?></option>
		        <option value="0mg">0 Mg</option>
                <option value="2mg">2 Mg</option>
                <option value="4mg">4 Mg</option>
                <option value="6mg">6 Mg</option>
...
<tr><td colspan="2" height="7"></td></tr>
             ...
             <?php if($indivdata->finish=='') {?>
             
             
               <tr>
               
             
         <td width="6%" align="left" class="caption-field"><label class="title">E-juice Finish :</label></td>
                <td width="94%" align="left" valign="middle">
                
                <select name="finish" id="finish" class="select_medium">
                <option value="">Select</option>
                <option value="Regular(90/10 PG/VG)">Regular (90/10 PG/VG)</option>
 ...
 <?php } else {?>
        ...
        <td width="7%" align="left" class="caption-field"><label class="title">E-Juice Finish:<span style=" color:#FF0000; font-size:14px">*</span></label></td>
        
        <td>
		<select name="finish" id="finish" class="select_medium">
         <option value="<?php echo  stripslashes($indivdata->finish);?>"><?php echo  stripslashes($indivdata->finish);?></option>
		  <option value="Regular(90/10 PG/VG)">Regular (90/10 PG/VG)</option>
                 <option value="Smooth(100 VG)">Smooth (100 VG)</option>
...
<input type="text" name="newprice" <?=$newpricediv?> id="newprice" class="text_small required" value="<?php echo $newprice;?>" onfocus="if(this.value=='New Price'){ value='' }" onblur="if(this.value==''){ value='New Price' }" />
       ...
       <!--       
             <tr>
                <td width="7%" align="left" class="caption-field"><label class="title">price:<span style=" color:#FF0000; font-size:14px">*</span></label></td>
                <td width="93%" colspan="4" align="left" valign="middle">  
				<input name="real_price" class="text_large required" type="text" value="<?php echo  stripslashes($indivdata->real_price);?>"/>
			   <tr>-->
...
$optin='';
				$sizelist=sizeClass::getAllsizeList('','','','');

				foreach($sizelist as $slist)

				{
				$optin=$optin."<option value='".$slist->size."'>".stripslashes($slist->size).'</option>';
				}
         ...
         <tr>
			   <?php     $asq="select * from tb_products_size where pid=".$_GET['id']." order by id"; 
			  ...
			  <td width="7%" align="left" class="caption-field"><label class="title">Size:<span style=" color:#FF0000; font-size:14px">*</span></label></td>
                ...
                <td width="93%" colspan="4" align="left" valign="middle">
					...
					<select name="sid[]" id="sid0" class="select_medium">
                <option value="">Select</option>
			<?=$optin?>
             ...
             <script type="text/javascript">
                ...
                <input type="text" name="rs[]" id="rs0"  value="<?php echo $price->price;?>"/>
&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>&nbsp;( If you want to add more sizes click below Plus button to Add ) </span></td>
</tr>
		<tr>	  
            <td></td>  
	 ...
	 $asq_1="select * from tb_products_size where pid=".$_GET['id']." order by id"; 
				          $price1=$callConfig->getAllRows($asq_1);
				$i=0;
     ...
     <select name='sid[]' id='sid<?=$i?>' class='select_medium'><option value=''>Select</option><?=$optin?></select>
       <script type="text/javascript">
     ...
     price:<input type='text' value="<?=$s_price->price?>" name='rs[]' id='rs<?=$i?>' class='inputtype_field_input' /></p><div class='clearfix'></div><a href='#' onClick='removeFormField("#row<?=$i?>"); return false;'><img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;right:-393px' /></a></div><br></div>
...
$("#divTxt").append("<div id='row" + id + "'><div style='border:1px solid #6DB5FF;width:390px; height:45px;padding:2px 2px 2px 2px;'><p><select name='sid[]' id='sid"+id+"' class='select_medium'><option value=''>Select</option><?=$optin?></select>price:<input type='text' name='rs[]' id='rs"+id+"' class='inputtype_field_input' /></p><div class='clearfix'></div><a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;'><img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;right:-393px' /></a></div><br></div>");
$("label").inFieldLabels(); 
	id = (id - 1) + 2;
...
<?php
				 ...
				 {
                 $optin='';
				 $asqffds="select * from tb_store_sku where c_lotid='".$indivdata->lotnumber."' "; 
				 $pricefgf=$callConfig->getALLRows($asqffds);
				foreach($pricefgf as $slist)
 
				{
				$optin=$optin."<option value='".$slist->id."'>".stripslashes($slist->x_dim2).'</option>';
				}
				 }else{
				$optin='';
				$sizelist=sizeClass::getAllsizeList('','','','');
         ...
         <tr>
			   <?php     $asq="select * from tb_store_sku where c_lotid='".$indivdata->lotnumber."' "; 
				         $price=$callConfig->getRow($asq);
             ...
             <script type="text/javascript">
                for(var i=0;i<document.getElementById('sid0').length;i++)
                {
						if(document.getElementById('sid0').options[i].value=="<?php echo $price->id;?>")
						{
						document.getElementById('sid0').options[i].selected=true
						}
                }			
                ...
                <input type="text" name="rs[]" id="rs0"  value="<?php echo $price->n_listprice;?>"/>
&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>&nbsp;( If you want to add more sizes click below Plus button to Add ) </span></td>
</tr>
		<tr>	  
            <td></td>  
	 ...
	 $asq1="select * from tb_store_sku where c_lotid='".$indivdata->lotnumber."' "; 
	...
	/*			$i=0;
     ...
     <select name='sid[]' id='sid<?=$i?>' class='select_medium'><option value=''>Select</option><?=$optin?></select>
       <script type="text/javascript">
                for(var i=0;i<document.getElementById('sid<?=$i?>').length;i++)
                {
						if(document.getElementById('sid<?=$i?>').options[i].value=="<?php echo $s_price->id;?>")
						{
						document.getElementById('sid<?=$i?>').options[i].selected=true
						}
                }			
                </script>
     price:<input type='text' value="<?=$s_price->n_listprice?>" name='rs[]' id='rs<?=$i?>' class='inputtype_field_input' /></p>
...
<?php   /*size
				...
				{
				$optin=$optin."<option value='".$slist->x_dim2."'>".stripslashes($slist->x_dim2).'</option>';
				}
				 }else{
				$optin='';
				$sizelist=sizeClass::getAllsizeList('','','','');
 ...
 <tr>
               <?php if($indivdata->prodsizes=='') {?>
             
         <td width="6%" align="left" class="caption-field"><label class="title">Bottle Size :</label></td>
                <td width="94%" align="left" valign="middle">
                
                <select name="prodsizes" id="colr" class="select_medium">
                <option value="">Select</option>
        ...
        <td width="7%" align="left" class="caption-field"><label class="title">Bottle Size:<span style=" color:#FF0000; font-size:14px">*</span></label></td>
        
        <td>
		<select name="prodsizes" id="prodsizes" class="select_medium">
         <option value="<?php echo  stripslashes($indivdata->prodsizes);?>"><?php echo  stripslashes($indivdata->prodsizes);?></option>
       ...
       <?php } ?>    
             ...
             <script type="text/javascript">
                ...
                for(var i=0;i<document.getElementById('sid0').length;i++)
                {
						if(document.getElementById('sid0').options[i].value=="<?php echo $price->x_dim2;?>")
						{
						document.getElementById('sid0').options[i].selected=true
						}
                }			
...
&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>&nbsp;( If you want to add more sizes click below Plus button to Add ) </span></td>-->
  ...
  <input type="text" name="real_price" id="real_price"  value="<?php echo  stripslashes($indivdata->real_price);?>"/>
&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>&nbsp;( If you want to add more sizes click below Plus button to Add ) </span></td>
     ...
     <select name='sid[<?php print $s_price->id;?>]' id='sid<?=$i?>' class='select_medium'><option value=''>Select</option><?php print $optin; ?></select>
       <script type="text/javascript">
                for(var i=0;i<document.getElementById('sid<?=$i?>').length;i++)
                {
						if(document.getElementById('sid<?=$i?>').options[i].value=="<?php echo $s_price->x_dim2;?>")
						{
						document.getElementById('sid<?=$i?>').options[i].selected=true
						}
                }			
    ...
    <script type="text/javascript">
	<?php 
	$all_xdims = $callConfig->getALLRows("SELECT * FROM tb_size GROUP BY size"); 
	$optino = '';
	foreach($all_xdims as $sin_dim){
		$optino .= "<option value='".$sin_dim->size."'>".$sin_dim->size."</option>";
	}
	?>
function addFormField() {
	var id = document.getElementById("id").value;
	var count =document.getElementById("countid").value;
$("#divTxt").append("<div id='row" + id + "'><div style='border:1px solid #6DB5FF;width:390px; height:45px;padding:2px 2px 2px 2px;'><p><select name='sid[]' id='sid"+id+"' class='select_medium'><option value=''>Select</option><option value='10ml'>10ml</option><option value='20ml'>20ml</option><option value='30ml'>30ml</option><option value='40ml'>40ml</option><option value='50ml'>50ml</option><option value='60ml'>60ml</option><option value='70ml'>70ml</option><option value='80ml'>80ml</option><option value='90ml'>90ml</option><option value='100ml'>100ml</option><?php print $optino; ?></select>price:<input type='text' name='rs[]' id='rs"+id+"' class='inputtype_field_input' /></p><div class='clearfix'></div><a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;'><img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;right:-393px' /></a></div><br></div>");
$("label").inFieldLabels(); 
	id = (id - 1) + 2;
	var countid = document.getElementById("countid").value;
	var b=1;
...
<!--images-->
			   ...
			   <tr>
				...
				<?php /*?> <tr><td colspan="2" height="7"></td></tr>
			   <tr>
				<td width="6%" align="left" valign="middle" class="caption-field"><label class="title">Sub Image1 :</label></td>
				<td width="94%" align="left" valign="middle"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
				<tr>
				<td width="31%"><input type="file" name="image2" size="24"></td>
				<td width="69%"><?php if($indivdata->image2!=""){
                ...
                <tr><td colspan="2" height="7"></td></tr>
			   <tr>
				<td width="6%" align="left" valign="middle" class="caption-field"><label class="title">Sub Image2 :</label></td>
				<td width="94%" align="left" valign="middle"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
				<tr>
				<td width="31%"><input type="file" name="image3" size="24"></td>
				<td width="69%"><?php if($indivdata->image3!=""){
                ...
                <tr><td colspan="5" height="7"></td></tr>
				<tr>
				<td width="7%" align="left" valign="middle" class="caption-field"><label class="title">Sub Image3 :<span style=" color:#FF0000; font-size:14px"></span></label></td>
				<td width="93%" colspan="4" align="left" valign="middle"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
				<tr>
				<td width="31%"><input type="file" name="image4" size="24"></td>
				<td width="69%"><?php if($indivdata->image4!=""){?>
				<img src="../uploads/store/products/<?php echo $indivdata->image4; ?>" width="150" height="150" />
				<input type="hidden" name="hdn_image4" size="24" value="<?php echo $indivdata->image4; ?>">
				<?php
				}
				?> <span style="font-size:11px">(Image sizes: width:380px height:550px)</span></td>
				</tr>
				...
				<tr><td colspan="2" height="7"></td></tr>
				<?php /*?><tr>
                <td width="6%" align="left" class="caption-field"><label class="title">Initial Stock :</label></td>
                <td width="94%" align="left" valign="middle"><input name="init_stock" class="text_small required" type="text" value="<?php echo  $indivdata->init_stock;?>"/></td>
	</tr>
			  <tr><td colspan="2" height="7"></td></tr>
			  <tr>
                <td width="6%" align="left" class="caption-field"><label class="title">Available Stock :</label></td>
                <td width="94%" align="left" valign="middle"><input name="aval_stock" class="text_small required" type="text" value="<?php echo  $indivdata->aval_stock;?>"/></td>
	</tr>
			  <tr><td colspan="2" height="7"></td></tr><?php */?>
             ...
             <!-- <tr><td colspan="2" height="7"></td></tr>
                  ...
                  <tr>
                <td width="6%" align="left" class="caption-field"><label class="title">Fabric :</label></td>
                <td><input  type="text" class="text_large required" name="fab" id="fab"  value="<?php echo  stripslashes($indivdata->fabric); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
                 <tr>
                <td width="6%" align="left" class="caption-field"><label class="title">Blend :</label></td>
                <td><input  type="text" class="text_large required" name="ble" id="ble"  value="<?php echo  stripslashes($indivdata->blend); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
               <tr>
                <td width="6%" align="left" class="caption-field"><label class="title">Care :</label></td>
                <td><input  type="text" class="text_large required" name="car" id="car"  value="<?php echo  stripslashes($indivdata->care); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
                
                <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Protection :</label></td>
                <td><input  type="text" class="text_large required" name="pro" id="pro"  value="<?php echo  stripslashes($indivdata->protection); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
                              
                <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Finish :</label></td>
                <td><input  type="text" class="text_large required" name="fin" id="fin"  value="<?php //echo  stripslashes($indivdata->finish); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
                ...
                <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Silhouette :</label></td>
                <td><input  type="text" class="text_large required" name="silh" id="silh"  value="<?php echo  stripslashes($indivdata->silhouette); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
               
                    <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Closure :</label></td>
                <td><input  type="text" class="text_large required" name="clos" id="clos"  value="<?php echo  stripslashes($indivdata->closure); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
                <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Collar :</label></td>
                <td><input  type="text" class="text_large required" name="coll" id="coll"  value="<?php echo  stripslashes($indivdata->collar); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
               
                  <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Length :</label></td>
                <td><input  type="text" class="text_large required" name="leng" id="leng"  value="<?php echo  stripslashes($indivdata->length); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
                  <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Cuff :</label></td>
                <td><input  type="text" class="text_large required" name="cuf" id="cuf"  value="<?php echo  stripslashes($indivdata->cuff); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
                <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Pocket :</label></td>
                <td><input  type="text" class="text_large required" name="poc" id="poc"  value="<?php echo  stripslashes($indivdata->pocket); ?>" /></td>
                </tr>
               <tr><td colspan="2" height="7"></td></tr>
               
               
                 <tr>
                 <td width="6%" align="left" class="caption-field"><label class="title">Waistband :</label></td>
                <td><input  type="text" class="text_large required" name="wai" id="wai"  value="<?php echo  stripslashes($indivdata->waistband); ?>" /></td>
                </tr>
             <?php /*?>  <tr><td colspan="2" height="7"></td></tr>
				<tr>
                <td align="left" class="caption-field"><label class="title">Display Order:</label> </td>
                <td align="left" valign="middle" class="caption-field"><input name="display_order" class="text_small required" type="text" value="<?php echo $indivdata->disp_order;?>" style="width:30px;"/></td>
			  </tr><?php */?>
               ...
               <tr>
                ...
                <td width="94%" align="left" valign="middle"><input name="page_title" class="text_large required" type="text" value="<?php echo  stripslashes($indivdata->title);?>" style="width:800px;"/></td>
			  </tr>
			  <tr><td colspan="2" height="7"></td></tr>
               <tr>
                <td width="6%" align="left" class="caption-field"><label class="title">Title Slug :</label></td>
                <td width="94%" align="left" valign="middle"><input name="title_slug" class="text_large required" type="text" value="<?php echo  stripslashes($indivdata->prodtitle_slug);?>" style="width:800px;"/><br />
                  <small style="color:#FF0000">*(Provide lotnumber as slugname)</small></td>
	</tr>
			  <tr><td colspan="2" height="7"></td></tr>
               <tr>
