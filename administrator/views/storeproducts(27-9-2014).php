...
<form action="index.php?option=com_storeproducts_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
			...
			//alert(str);
              ...
              //var category=document.getElementById('scid').value;
			  if(str=='1')
			  {
				  //echo "hai";
				 var ss=document.getElementById('sarat').style.display="block";  
				  var ss1=document.getElementById('sarat1').style.display="block";  
				 } 
				 else {}
				  if(str=='2'){
					 var ss=document.getElementById('sarat2').style.display="block";  
				var ss1=document.getElementById('sarat3').style.display="block";  

					 }
			  }
              </script>
              
               <tr id="sarat" style="display:none">
		...
		<select name="nicotinecontent" id="nicotinecontent" class="select_medium">
         ...
         <script type="text/javascript">
               ...
               <tr><td colspan="5" height="7"></td></tr>
                  ...
                  <tr id="sarat1" style="display:none">
         ...
         <option value="<?php echo  stripslashes($indivdata->finish);?>"><?php echo  stripslashes($indivdata->finish);?></option>
		  <option value="Regular(90/10 PG/VG)">Regular (90/10 PG/VG)</option>
                ...
                <tr><td colspan="2" height="7"></td></tr>
                 ...
                 <tr id="sarat2" style="display:none">
        ...
        <input type="checkbox"  name="vcolors[]"  value="green"/>Green
         ...
         <input type="checkbox" name="vcolors[]"  value="Yellow"/>Yellow
             ...
             <tr><td colspan="2" height="7"></td></tr>   
              ...
              <tr id="sarat3" style="display:none">
...
<?php
         ...
         <tr>
             ...
             <script type="text/javascript">
                ...
                <input type="text" name="brs[]" id="brs0"  value="<?php echo $price->bulk_price;?>"/>
  <strong>Weight(oz):</strong>
               
                <input type="text" name="wrs[]" id="wrs0"  value="<?php echo $price->weight;?>"/>
                
                
                
                <strong>Quantity:</strong>
               
                <input type="text" name="qns[]" id="qns0"  value="<?php echo $price->quantity;?>"/>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=" color:#FF0000; font-size:14px;margin-left:30px;">*</span>(If you want to add more sizes click below Plus button to Add ) </span></td>
     ...
     <div id='row<?=$i?>'><div style='border:1px solid #6DB5FF; width:971px; height:45px;padding:2px 2px 2px 2px;'><p>
     ...
     price:<input type='text' value="<?=$s_price->real_price?>" name='rs[]' id='rs<?=$i?>' class='inputtype_field_input' />&nbsp;&nbsp;Bulk price:<input type='text' value="<?=$s_price->bulk_price?>" name='brs[]' id='brs<?=$i?>' class='inputtype_field_input' />&nbsp;&nbsp;Weight(oz):<input type='text' value="<?=$s_price->weight?>" name='wrs[]' id='wrs<?=$i?>' class='inputtype_field_input' />&nbsp;&nbsp;Quantity: <input type='text' value="<?=$s_price->quantity?>" name='qns[]' id='qns<?=$i?>' class='inputtype_field_input' /></p>
...
$("#divTxt").append("<div id='row" + id + "'><div style='border:1px solid #6DB5FF;width:980px; height:45px;padding:2px 2px 2px 2px;'><p><select name='sid[]' id='sid"+id+"' class='select_medium'><option value=''>Select</option><?php print $optino; ?></select> price:<input type='text' name='rs[]' id='rs"+id+"' class='inputtype_field_input' /> Bulk Price:<input type='text' name='brs[]' id='brs"+id+"' class='inputtype_field_input' />  Weight(oz):<input type='text' name='wrs[]' id='wrs"+id+"' class='inputtype_field_input' />Quantity:<input type='text' name='qns[]' id='qns"+id+"' class='inputtype_field_input' /> </p><div class='clearfix'></div><a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;'><img src='allfiles/Delete-Button_06.png' alt='delete' style='position:relative;top:-56px;float:right;right:-35px' /></a></div><br></div>");
$("label").inFieldLabels(); 
	id = (id - 1) + 2;
