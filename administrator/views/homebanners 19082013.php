...
<div id="contentLeft" style="border:0px solid red;">
      <ul style="margin:0px;margin-left:-40px;margin-top:6px;">
        <li class="listyle" style="border:1px solid #CCCCCC;background-color:#F2F2F2;">
          <table width="100%">
            <thead>
              <tr height="25">
    ...
    <ul style="margin:0px;margin-left:-40px;">
				...
				{
				?>
        <li id="recordsArray_<?php echo $row['id']; ?>" class="listyle" >
          <table width="101%" border="0" style="border:1px solid #EDE8E8;">
            <tr height="25">
              ...
              <td width="72" align="center" valign="middle" ><a title="edit" href="index.php?option=com_bannerslist_insert&id=<?php echo $row['id']?>"><img src="allfiles/icon_edit.png" alt="Edit" border="0"></a></td>
              <td width="86" align="center" valign="middle" ><a title="delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_bannerslist&action=delete&id=<?php echo $row['id'];?>'; return false;}"><img src="allfiles/icon_delete.png"  alt="Delete" border="0"/></a> </td>
            </tr>
          </table>
        </li>
        <?php 
...
<form action="index.php?option=com_bannerslist_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate();">
	...
	<tr>
			  ...
			  <tr><td colspan="2" height="7"></td></tr>
                ...
                <td align="left" valign="middle" class="caption-field"><textarea name="bigtext" id="bigtext"  cols="150" rows="5"><?php echo  stripslashes($indivdata->bigtext);?></textarea>
				<?php /*?><?
