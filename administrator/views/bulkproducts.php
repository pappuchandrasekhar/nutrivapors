...
<tr>
<td align="left" valign="middle"><h1><img src="allfiles/map.jpeg" alt=""> Store &nbsp;&nbsp;>>&nbsp;&nbsp;Monthly Special Bulk Products</h1></td>
...
<div class="content">
	 <table width="100%" border="0" cellpadding="0" cellspacing="0"  id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
          <thead>
           ...
           <?php /*?> <?php $qq="select * from tb_store_products where spid=".$all_products->sscid;
			      $ssq=mysql_query($qq); 
				  $ffq=mysql_fetch_array($ssq); 
				  $prod=$ffq['all_products'];  ?><?php */?>
                  
			<td align="middle" valign="middle"><?php echo  $all_products->prodtitle;?></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="left" valign="middle"> <h1><img src="allfiles/map.jpeg" alt=""> Store &nbsp;&nbsp;>>&nbsp;&nbsp;Add Monthly Special Bulk Products&nbsp;&nbsp;/&nbsp;&nbsp; Edit Monthly Special Bulk Products</h1></td>
...
<form action="index.php?option=com_bulkproducts_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
               ...
               <tr>
                ...
                <td width="94%" align="left" valign="middle">
                 <?php $q="select * from tb_store_products";
			         $res=mysql_query($q);
			    ?>
              ...
              <select name="sscid" id="txtHint1" class="select_medium required" onchange="" required="required">
				...
				<?php while($row=mysql_fetch_array($res)){ ?>
                  <option value="<?php echo $row['id']?>,<?php echo $row['prodtitle']?>"><?php echo $row['prodtitle']?></option>
...
<?php } ?>
                ...
                {
						if(document.getElementById('txtHint1').options[i].value=="<?php echo $indivdata->sscid;?>")
						{
