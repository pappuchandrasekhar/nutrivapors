          ...
          <thead>
            <tr height="40">
              <th width="20" align="center" valign="middle">sno</th>
			   <th width="238" align="left" valign="middle" >title</th>
              <th width="220" align="left" valign="middle" >Image</th>
			  <th width="46" align="center" valign="middle" >Status</th>
              <th width="34" align="center" valign="middle" >Edit</th>
			  <th width="38" align="center" valign="middle" >Delete</th>
            </tr>
          </thead>
			<tbody>
			<?php
			...
			<td  align="middle" valign="middle" ><?php echo stripslashes($allforum_list->subcatetitle);?></td>
            <td  align="middle" valign="middle"><img src="../uploads/store/subcategory/<?php echo $allforum_list->image; ?>" height="60" width="60"/></td>
...
{  
	...
	<?php /*?>var news_info = tinyMCE.get('bigtext').getContent();
...
<form action="index.php?option=com_storesubcat_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate(this.image);">
    ...
    <tr><td colspan="2" height="7"></td></tr>
     <tr>
				...
				?>
				<img src="../uploads/store/subcategory/<?php echo $indivdata->image; ?>" width="150" height="150" />
