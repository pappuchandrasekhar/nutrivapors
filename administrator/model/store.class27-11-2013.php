...
//		}
	...
	$fieldnames=array('scid'=>$post['scid'],'sscid'=>$_POST['sscid'],'bid'=>$post['bid'],'prodtitle'=>mysql_real_escape_string($post['prodtitle']),'prodsizes'=>$sizepro,'prodtitle_slug'=>$titleslug,'bigtext'=>mysql_real_escape_string($post['content']),'image'=>$prodimage,'image2'=>$prodimage2,'image3'=>$prodimage3,'image4'=>$prodimage4,'color'=>$post['color'],'colorstab'=>$colors,'real_price'=>$post['real_price'],'featuredlisting'=>$_POST['featured'],'disp_order'=>$post['display_order'],'aval_stock'=>$post['aval_stock'],'title'=>mysql_real_escape_string($post['page_title']),'title_slug'=>$titleslug,'meta_keyword'=>mysql_real_escape_string($post['meta_keyword']),'meta_desc'=>mysql_real_escape_string($post['meta_desc']),'status'=>$post['status']);
