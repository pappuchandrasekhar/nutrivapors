...
-->
 ...
 //echo $products="select * from tb_store_products where scid=".$_GET['id']." and status =  'Active' order by spid DESC  limit ".$start.",".$limit."";
	   ...
	   $maxwidth = 175; // largest allowed width
 	  $maxheight = 175;  // largest allowed height
	 
 //list($width, $height, $type) = @getimagesize("http://192.254.233.173/~rajeshch/nutrivapors/uploads/store/products/".$prolist->image);     list($width, $height, $type) = @getimagesize("'".SITEURL."'/uploads/store/products/".$prolist->image);
 	  ...
 	  //$maxheight = 194;  // largest allowed height
        ...
        $thumbwidth = $width;
            ...
            <!--  <a href="product_discription.php?spid=<?php echo $prolist->spid?>">-->
               ...
               <img src="<?=SITEURL?>/uploads/store/products/<?php echo $prolist->image;?>" alt="" class="res_images" width="<?php echo $thumbwidth?>" height="<?php echo $thumbheight?>">
               
               <?php }else {?>
                 <img src="<?=SITEURL?>/images/sitelogo_04.png" alt="" class="res_images" width="<?php echo $thumbwidth?>" height="<?php echo $thumbheight?>">
               <?php }?>
               ...
               <form method="post">
                ...
                <input type="hidden" value="Add to Cart" name="submit">
                <input type="image" src="<?=SITEURL?>/images/cartround_55.png" name="submit">
                <!--<a href="#"><img src="<?=SITEURL?>/images/cartround_55.png" alt=""></a>--></span>
                
                
                <?php if($prolist->real_price!=""){ ?>
                
                 <span style="float:left; padding-left:15px; margin-top:5px;"><h3>$<?php echo $prolist->real_price;?></h3></span>
